...
//#define F_CPU 8000000UL  //TODO: This is  doubled (main.c)
...
const uint8_t Font1608[95][16] PROGMEM = {      
	...
	// a podstawione za X
	//{0x00,0x00,0x00,0x98,0x01,0x24,0x01,0x44,0x01,0x44,0x01,0x44,0x00,0xFC,0x00,0x04},/*"a",65*/	//ok
		
	// _ podstawione za X	
	//{0x00,0x01,0x00,0x01,0x00,0x01,0x00,0x01,0x00,0x01,0x00,0x01,0x00,0x01,0x00,0x01},/*"_",63*/	//ok
		
	// ] podstawione za X	
	//{0x00,0x00,0x40,0x02,0x40,0x02,0x40,0x02,0x7F,0xFE,0x00,0x00,0x00,0x00,0x00,0x00},/*"]",61*/	//ok
		
	// \ podstawione za X
	//{0x00,0x00,0x30,0x00,0x0C,0x00,0x03,0x80,0x00,0x60,0x00,0x1C,0x00,0x03,0x00,0x00},/*"\",60*/	// ok
...
//arek            if(mode)temp = Font1206[ch][i];
//arek            else temp = ~(Font1206[ch][i]);
        }
        else 
        {            
